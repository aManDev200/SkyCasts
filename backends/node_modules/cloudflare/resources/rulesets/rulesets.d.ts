...
export declare namespace RulesetCreateResponse {
    interface RulesetsLogCustomFieldRule {
        /**
    ...
    namespace RulesetsLogCustomFieldRule {
        /**
         * The parameters configuring the rule's action.
         */
    ...
    interface RulesetsDDoSDynamicRule {
        /**
         * The timestamp of when the rule was last modified.
         */
        last_updated: string;
    ...
    interface RulesetsForceConnectionCloseRule {
        /**
         * The timestamp of when the rule was last modified.
         */
        last_updated: string;
...
export interface RulesetUpdateResponse {
     ...
     * The list of rules in the ruleset.
     */
    rules: Array<RulesAPI.BlockRule | RulesAPI.ChallengeRule | RulesAPI.CompressResponseRule | RulesAPI.ExecuteRule | RulesAPI.JSChallengeRule | RulesAPI.LogRule | RulesAPI.ManagedChallengeRule | RulesAPI.RedirectRule | RulesAPI.RewriteRule | RulesAPI.RouteRule | RulesAPI.ScoreRule | RulesAPI.ServeErrorRule | RulesAPI.SetConfigRule | RulesAPI.SkipRule | RulesAPI.SetCacheSettingsRule | RulesetUpdateResponse.RulesetsLogCustomFieldRule | RulesetUpdateResponse.RulesetsDDoSDynamicRule | RulesetUpdateResponse.RulesetsForceConnectionCloseRule>;
    /**
     * The version of the ruleset.
     */
    version: string;
...
export interface RulesetGetResponse {
     ...
     * The list of rules in the ruleset.
     */
    rules: Array<RulesAPI.BlockRule | RulesAPI.ChallengeRule | RulesAPI.CompressResponseRule | RulesAPI.ExecuteRule | RulesAPI.JSChallengeRule | RulesAPI.LogRule | RulesAPI.ManagedChallengeRule | RulesAPI.RedirectRule | RulesAPI.RewriteRule | RulesAPI.RouteRule | RulesAPI.ScoreRule | RulesAPI.ServeErrorRule | RulesAPI.SetConfigRule | RulesAPI.SkipRule | RulesAPI.SetCacheSettingsRule | RulesetGetResponse.RulesetsLogCustomFieldRule | RulesetGetResponse.RulesetsDDoSDynamicRule | RulesetGetResponse.RulesetsForceConnectionCloseRule>;
    /**
     * The version of the ruleset.
     */
    version: string;
...
export interface RulesetUpdateParams {
     ...
     * Body param: The list of rules in the ruleset.
     */
    rules: Array<RulesAPI.BlockRuleParam | RulesAPI.ChallengeRuleParam | RulesAPI.CompressResponseRuleParam | RulesAPI.ExecuteRuleParam | RulesAPI.JSChallengeRuleParam | RulesAPI.LogRuleParam | RulesAPI.ManagedChallengeRuleParam | RulesAPI.RedirectRuleParam | RulesAPI.RewriteRuleParam | RulesAPI.RouteRuleParam | RulesAPI.ScoreRuleParam | RulesAPI.ServeErrorRuleParam | RulesAPI.SetConfigRuleParam | RulesAPI.SkipRuleParam | RulesAPI.SetCacheSettingsRuleParam | RulesetUpdateParams.RulesetsLogCustomFieldRule | RulesetUpdateParams.RulesetsDDoSDynamicRule | RulesetUpdateParams.RulesetsForceConnectionCloseRule>;
    /**
     * Path param: The Account ID to use for this endpoint. Mutually exclusive with the
     * Zone ID.
     */
