...
class Language extends resource_1.APIResource {
    ...
    update(identifier, language, params, options) {
        ...
        return this._client.put(`/accounts/${account_id}/stream/${identifier}/captions/${language}`, (0, core_1.multipartFormRequestOptions)({ body, ...options }))._thenUnwrap((obj) => obj.result);
    }
    /**
