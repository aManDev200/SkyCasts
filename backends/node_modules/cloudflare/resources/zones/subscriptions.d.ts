...
import * as ZonesSubscriptionsAPI from "./subscriptions.js";
import * as SubscriptionsAPI from "../user/subscriptions.js";
import { SubscriptionsSinglePage } from "../user/subscriptions.js";
export declare class Subscriptions extends APIResource {
     ...
     */
    list(accountIdentifier: string, options?: Core.RequestOptions): Core.PagePromise<SubscriptionsSinglePage, SubscriptionsAPI.Subscription>;
    /**
