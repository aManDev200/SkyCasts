...
import * as HotlinkProtectionAPI from "./hotlink-protection.js";
export declare class HotlinkProtectionResource extends APIResource {
    /**
     ...
     */
    edit(params: HotlinkProtectionEditParams, options?: Core.RequestOptions): Core.APIPromise<HotlinkProtection>;
    /**
     * When enabled, the Hotlink Protection option ensures that other sites cannot suck
     * up your bandwidth by building pages that use images hosted on your site. Anytime
     * a request for an image on your site hits Cloudflare, we check to ensure that
...
export declare namespace HotlinkProtectionResource {
...
//# sourceMappingURL=hotlink-protection.d.ts.map