...
import * as ServerSideExcludesAPI from "./server-side-excludes.js";
export declare class ServerSideExcludes extends APIResource {
    /**
     ...
     */
    edit(params: ServerSideExcludeEditParams, options?: Core.RequestOptions): Core.APIPromise<ServerSideExcludes>;
    /**
     * If there is sensitive content on your website that you want visible to real
     * visitors, but that you want to hide from suspicious visitors, all you have to do
     * is wrap the content with Cloudflare SSE tags. Wrap any content that you want to
     ...
     * (https://support.cloudflare.com/hc/en-us/articles/200170036).
     */
    get(params: ServerSideExcludeGetParams, options?: Core.RequestOptions): Core.APIPromise<ServerSideExcludes>;
}
/**
 * If there is sensitive content on your website that you want visible to real
 * visitors, but that you want to hide from suspicious visitors, all you have to do
...
export declare namespace ServerSideExcludes {
...
//# sourceMappingURL=server-side-excludes.d.ts.map