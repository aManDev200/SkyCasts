...
export declare class Top extends APIResource {
     ...
     */
    browserFamilies(query?: TopBrowserFamiliesParams, options?: Core.RequestOptions): Core.APIPromise<TopBrowserFamiliesResponse>;
...
export declare namespace TopBrowserFamiliesResponse {
    interface Meta {
...
export declare namespace TopBrowsersResponse {
    interface Meta {
        dateRange: Array<Meta.DateRange>;
        lastUpdated: string;
        confidenceInfo?: Meta.ConfidenceInfo;
