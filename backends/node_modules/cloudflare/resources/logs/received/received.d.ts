...
import * as ReceivedAPI from "./received.js";
import * as FieldsAPI from "./fields.js";
export declare class Received extends APIResource {
     ...
     */
    get(zoneIdentifier: string, query: ReceivedGetParams, options?: Core.RequestOptions): Core.APIPromise<ReceivedGetResponse>;
}
