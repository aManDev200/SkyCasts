...
import * as UserSchemasOperationsAPI from "./operations.js";
...
export declare class Operations extends APIResource {
     ...
     */
    list(schemaId: string, params: OperationListParams, options?: Core.RequestOptions): Core.PagePromise<OperationListResponsesSinglePage, OperationListResponse>;
}
export declare class OperationListResponsesSinglePage extends SinglePage<OperationListResponse> {
}
