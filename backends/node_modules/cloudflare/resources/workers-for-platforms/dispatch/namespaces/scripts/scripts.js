...
class Scripts extends resource_1.APIResource {
    ...
    update(dispatchNamespace, scriptName, params, options) {
        ...
        return this._client.put(`/accounts/${account_id}/workers/dispatch/namespaces/${dispatchNamespace}/scripts/${scriptName}`, (0, core_1.maybeMultipartFormRequestOptions)({
            body,
            ...options,
