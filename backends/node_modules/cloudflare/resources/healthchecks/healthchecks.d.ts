...
export declare class Healthchecks extends APIResource {
     ...
     */
    list(params: HealthcheckListParams, options?: Core.RequestOptions): Core.PagePromise<HealthchecksSinglePage, Healthcheck>;
    /**
...
export declare class HealthchecksSinglePage extends SinglePage<Healthcheck> {
}
/**
