...
import * as DetailsAPI from "./details.js";
import { SinglePage } from "../../../pagination.js";
export declare class Events extends APIResource {
    details: DetailsAPI.Details;
    /**
     ...
     */
    list(waitingRoomId: string, params: EventListParams, options?: Core.RequestOptions): Core.PagePromise<EventsSinglePage, Event>;
    /**
...
export declare class EventsSinglePage extends SinglePage<Event> {
}
