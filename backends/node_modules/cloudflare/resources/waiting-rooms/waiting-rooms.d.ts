...
export declare class WaitingRooms extends APIResource {
     ...
     * Lists waiting rooms.
     */
    list(params: WaitingRoomListParams, options?: Core.RequestOptions): Core.PagePromise<WaitingRoomsSinglePage, WaitingRoom>;
    /**
...
export declare class WaitingRoomsSinglePage extends SinglePage<WaitingRoom> {
}
