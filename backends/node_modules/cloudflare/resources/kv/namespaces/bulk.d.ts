...
export declare class Bulk extends APIResource {
     ...
     */
    update(namespaceId: string, params: BulkUpdateParams, options?: Core.RequestOptions): Core.APIPromise<BulkUpdateResponse | null>;
    /**
     * Remove multiple KV pairs from the namespace. Body should be an array of up to
     * 10,000 keys to be removed.
     */
    delete(namespaceId: string, params: BulkDeleteParams, options?: Core.RequestOptions): Core.APIPromise<BulkDeleteResponse | null>;
}
...
export declare namespace BulkUpdateParams {
    interface Body {
        /**
